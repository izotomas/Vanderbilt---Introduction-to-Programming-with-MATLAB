%{
Write a function that is called like this: amag = accelerate(F1,F2,m). F1
and F2 are three-element column vectors that represent two forces applied
...
object?s acceleration vector a by using Newton?s law: F = ma, where F is 
the sum of F1 and F2. Then it returns the magnitude of a.
%}
